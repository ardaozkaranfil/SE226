...
class Car(Vehicle):
    ...
    def __str__(self):
        return (f"[Car] VID: {self.vid} | {self.model} ({self.year}) "
                f"| Fuel: {self.fuel_type} | {self.doors} Doors")
...
class Truck(Vehicle):
    ...
    def __str__(self):
        return (f"[Truck] VID: {self.vid} | {self.model} ({self.year}) "
                f"| Load: {self.max_load}kg | {self.axles} Axles")
...
class Motorcycle(Vehicle):
    ...
    def __str__(self):
        return (f"[Motorcycle] VID: {self.vid} | {self.model} ({self.year}) "
                f"| Eng: {self.engine_cc}cc | Type: {self.type}")
